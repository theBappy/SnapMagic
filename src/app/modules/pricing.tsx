            ...
            >
              ...
              >
                <div className="text-center mb-8">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 g-linear-to-br from-primary to-secondary group-hover:animate-glow-pulse">
